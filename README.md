...
> Status: `v0.1.2` public release. The included catalog is entirely synthetic. The workflow does not calculate audience size, create segments or send campaigns.
